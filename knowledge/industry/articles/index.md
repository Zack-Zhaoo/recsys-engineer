...
本目录收录 2026-08-28 之前的公司工程文章、团队公众号文章、官方研究页面和少量高质量中文解读。只保存链接、证据级别与短摘要，不复制原文。
...
6. 各公司的条目数反映的是可采集性，不是产出量。设有公开技术博客、条目带日期且可被检索的公司更容易被持续收录；主要在微信公众号发布的团队，很难按时间窗检索到一手原文，因而系统性偏少。读到某家公司条目稀少时，不应据此推断它在该方向投入不足。
